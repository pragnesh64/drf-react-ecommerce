...
from api.models import Category, Brand, Product, Coupon
...
PRODUCTS = [
    ...
    ("Apple iPhone 15 Pro", 2, 0, 9999.99, 10, "Apple's most powerful iPhone with A17 Pro chip."),
    ("Apple MacBook Air M2", 2, 0, 9999.00, 7, "Ultra-thin laptop with M2 chip, 18hr battery."),
    ("Philips Air Fryer", 4, 3, 8999.00, 25, "Digital air fryer, 6.2L, rapid air technology."),
    ("Philips Smart Bulb", 4, 3, 1499.00, 50, "Wi-Fi enabled smart LED bulb, 16M colors."),
    ("Nike Air Max 270", 1, 1, 5999.00, 20, "Lightweight running shoes with Air cushioning."),
    ("Nike Dri-FIT T-Shirt", 1, 1, 1999.00, 40, "Moisture-wicking athletic T-shirt."),
    ("Nike Sports Bag", 1, 4, 3499.00, 18, "Large capacity gym bag with shoe pocket."),
    ("Clean Code Book", 3, 2, 799.00, 30, "A handbook of agile software craftsmanship."),
    ("Django for Beginners", 3, 2, 699.00, 22, "Step-by-step guide to building Django web apps."),
    ("React JS Complete Guide", 3, 2, 749.00, 28, "Comprehensive React.js guide for beginners."),
    ("Stainless Steel Water Bottle", 4, 3, 599.00, 60, "BPA-free 1L insulated water bottle."),
    ("Yoga Mat", 1, 4, 1299.00, 35, "Non-slip TPE yoga mat with carry strap."),
    ("Resistance Bands Set", 1, 4, 899.00, 45, "Set of 5 resistance bands for home workouts."),
    ...
    ("Linen Formal Shirt", 1, 1, 1299.00, 35, "Premium linen formal shirt, multiple colors."),
    ("Running Track Pants", 1, 1, 1499.00, 30, "Lightweight track pants with zip pockets."),
]
...
class Command(BaseCommand):
    help = 'Populate the database with sample data for demo'
    ...
    def handle(self, *args, **options):
        ...
        for i in range(1, 11):
            if not User.objects.filter(username=f'user{i}').exists():
                User.objects.create_user(f'user{i}', f'user{i}@shopsphere.com', 'pass1234')
        ...
        self.stdout.write('  20 products created')
        ...
        self.stdout.write('  5 coupons created')

        self.stdout.write(self.style.SUCCESS('\nDone! Login: admin/admin123, Users: user1-user10/pass1234'))
